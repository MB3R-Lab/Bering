...
2. move to `io.mb3r.bering.model@1.1.0` when you need the typed placement, reliability, operation-aware edge identity, resilience, observed-edge, and endpoint-fidelity fields
